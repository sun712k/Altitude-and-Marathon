...
This project investigates whether altitude influences elite marathon performance. Specifically, it examines whether runners born (or possibly training) in high-altitude regions perform better, and how individual factors — **age, sex, BMI** — and socioeconomic variables — **population size and national income** — interact with athletic outcomes.

Since many researchers hypothesize that regional altitude affects endurance through physiological mechanisms, the second stage of this study analyzes **within-country variation**, testing whether runners born in higher-altitude regions perform better after controlling for country-level factors. This approach helps isolate potential physiological effects while minimizing confounding influences such as genetics, culture, and socioeconomic status.

> *If altitude is truly a causal driver of endurance performance (e.g., through oxygen adaptation or VO₂ max improvements), the relationship should appear both **across** and **within** countries. Conversely, if the observed correlation arises from cultural or selection effects, the relationship may disappear when examined within countries.*

The project combines both **between-country** and **within-country** analyses to distinguish physiological effects of altitude from cultural or economic influences.
...
4. **Are many elite runners from Ethiopia and Kenya actually born in high-altitude regions?**
   → Yes. Many runners from Kenya and Ethiopia—two of the top-performing countries—were born in regions situated above their respective national average elevations(750m and 1,330m, respectively). 
...
* Incorporate **detailed training-location data** to more accurately capture “train-high” effects.
* Explore **cultural and physiological mechanisms** beyond altitude, such as running economy or motivational factors.
